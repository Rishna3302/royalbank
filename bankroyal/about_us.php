...
<head>
    ...
    <title>About us - Royal Bank</title>
...
<body style="background-color:navy;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="statics/royal.jpg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Royal Rishna Patra</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> Jyoti Nivas College Autonomous, Bangalore</b></p>
    </center>
